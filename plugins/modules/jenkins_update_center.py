...
def main():
    ...
    update_ctr_config = os.path.join(
        module.params["jenkins_home"], "hudson.model.UpdateCenter.xml"
    )
    ...
    if module.params["update_center_id"] == "default":
        ...
        changed = append(
            tree, module.params["update_center_id"], module.params["update_center_url"]
        )
    if changed:
